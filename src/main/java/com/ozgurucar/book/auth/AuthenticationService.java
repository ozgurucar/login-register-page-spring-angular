...
import com.ozgurucar.book.role.RoleRepository;
import com.ozgurucar.book.security.JwtService;
import com.ozgurucar.book.user.Token;
import com.ozgurucar.book.user.TokenRepository;
import com.ozgurucar.book.user.User;
...
public class AuthenticationService {
    ...
    public void activateAccount(String token) throws MessagingException {
        ...
        if (LocalDateTime.now().isAfter(savedToken.getExpiresAt())) {
            ...
            throw new RuntimeException("Activation token has been expired. A new token has been sent to the same email.");
        }
